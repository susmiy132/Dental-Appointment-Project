...
public class UserService implements UserDetailsService {
    ...
    public ResponseObjectService findById(String id) {
        ResponseObjectService responseObj = new ResponseObjectService();
        Optional<UserEntity> optUser = userRepo.findById(Long.valueOf(id));
        if (optUser.isEmpty()) {
        ...
        if (optUser.isEmpty()) {
            ...
            if (followerIds.size() > 0) {
                for (String followerId : followerIds) {
                    Optional<UserEntity> optFollowerUser = userRepo.findById(Long.valueOf(followerId));
    ...
    public ResponseObjectService saveUser(UserEntity inputUser) {
        ...
        if (optUser.isPresent()) {
            ...
            listFollowing.add(String.valueOf(user.getId()));
    ...
    public ResponseObjectService followUser(DoubleIdObjectEntity doubleId) {
        ...
        ResponseObjectService responseObj = new ResponseObjectService();
        Optional<UserEntity> optFollowedUser = userRepo.findById(Long.valueOf(doubleId.getId1()));
        Optional<UserEntity> optFollower = userRepo.findById(Long.valueOf(doubleId.getId2()));
